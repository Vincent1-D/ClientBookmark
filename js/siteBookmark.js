...
async function renderBookmarks() {
    ...
    if (bookmarks !== null) {
        bookmarks.forEach(bookmark => {
            if (!category.includes(bookmark.Category)) {
                category.push(bookmark.Category);
            }
...
function renderBookmarkForm(bookmark = null) {
    ...
    $("#content").append(`
        ...
        <form class="form" id="bookmarkForm">
            ...
            <input 
                ...
                required
                RequireMessage="Veuillez une categorie" 
    ...
    $("input[name=Url]").on('change', function() { 
        ...
        $("#favionUrl").attr('src',"https://www.google.com/s2/favicons?sz=32&domain_url=" + this.value)
   }); 
;
